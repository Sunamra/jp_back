      ...
      <div className="px-1">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Career<span className='text-[#e3321f] font-caveat'>Sync</span></h2>
            <p className="text-sm mt-[4px]">© 2024 CareerSync Private Limited. All rights reserved.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-[#3b5998] transition-all duration-200" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-[#1DA1F2] transition-all duration-200" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-[#006699] transition-all duration-200" aria-label="LinkedIn">
