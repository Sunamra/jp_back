	...
	const submitHandler = async (e) => {
		...
		try {
			...
			if (input.password.trim().length < 3) {
				toast.error("Password requires at least 3 characters")
	...
	return (
		<div>
			...
			<div className='flex items-center justify-center max-w-7xl mx-auto'>
				<form onSubmit={submitHandler} className='w-1/2 min-w-[350px] border border-black rounded-md p-4 my-10'>
					...
					<div className='flex flex-col justify-between'>
						...
						<div className='flex items-center gap-2'>
							...
							<Input
								...
								className="cursor-pointer max-w-[255px]"
							/>
						</div>
					</div>
					{
